...
$query = 'SELECT user_id, email, pass FROM users ORDER BY user_id ASC' ;
...
<p>Change password to= <input type="text" name="pass" value="<?php if (isset($_POST['pass'])) echo $_POST['pass']; ?>"> </p>
